...
module.exports = {
    name: 'ynet-news',
    cooldown: 60,
    description: 'Latest headlines from ynet, beware that cooldown is higher here',
    async execute(message) {
        try {
            let response = await snekfetch.get(`https://newsapi.org/v2/top-headlines?sources=ynet&apiKey=${newsAPI}`);
