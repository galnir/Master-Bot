  ...
  const Dashboard = new DBD.Dashboard({
    ...
    theme: DarkDashboard({
      information: {
        ...
        supportServer: "https://discord.me/developer-corner",
        imageFavicon: "https://i.imgur.com/wDszTu6.png",
        iconURL: "https://i.imgur.com/wDszTu6.png",
      ...
      index: {
        ...
        information: {
          ...
          title: "Notice",
          description: "Click 'ADD BOT' in the top left corner to add the bot to your server.",
          footer: "Discord Bot Dashbaord"
        },
        feeds: {
          category: "Credits",
