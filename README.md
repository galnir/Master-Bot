...
For the bot to run, your system needs to have Node.js v16 and Python 3 (for compiling some Node.js module dependencies) installed.
...
- `maxQueueLength` (`integer` above `1`) : maximum numbers of songs that can be in queue
